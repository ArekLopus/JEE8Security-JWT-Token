...
public class ClientProtectedFailAdmin {
	
	public ClientProtectedFailAdmin() throws Exception {
		...
		String token = TokenUtilsConsole.generateTokenConsoleSeconds("John Doe", Arrays.asList("admin"), 3);
